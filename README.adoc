...
generation of random adjective and noun by setting a property called `appNamePrefix` in which case this will
...
The prefixing of app deployment with a unique id is enabled by default. This can be disabled by setting `enableRandomAppNamePrefix` to false.
